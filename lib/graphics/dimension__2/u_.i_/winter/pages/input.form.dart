...
class _FormState extends State<Form> {
  ...
  late gui__base__widget pageTitle;
  late List<gui__base__widget> children;
...
class _ChoiceInputFormItemState extends State<ChoiceInputFormItem> {
  late gui__base__widget _widget, widgetWithoutResult;
  ...
  @override
  gui__base__widget build(final BuildContext context) => _widget;
}
