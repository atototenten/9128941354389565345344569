...
widget___protocol widget__advanced__build /*
sample :"
widget__advanced__build(
...
" */ <storage___type>(
  ...
  required final widget__advanced__build___procedure__format<storage___type> child__build,
}) {
  return _widget__advanced__building<storage___type>(
...
@immutable
class _widget__advanced__building<storage___type> /*
...
- inspired by "StatefulBuilder" of "flutter/widgets/basic.dart" */ //
  ...
  const _widget__advanced__building({
...
refer to "_widget__building.child__build" */,
  ...
  final widget__advanced__build___procedure__format<storage___type> child__build;

  @override
  _widget__advanced__building__state<storage___type> //
  createState() {
    return _widget__advanced__building__state<storage___type>();
  }
}

class _widget__advanced__building__state<storage___type> //
    extends State<_widget__advanced__building<storage___type>> {
  ...
  /*@override
  void didUpdateWidget(/*covariant*/ final _widget__advanced__building<storage___type> widget__old) {
...
widget___protocol widget__basic__build({
  required final widget__build___procedure__format child__build,
}) {
  return _widget__basic__building(
    child__build: child__build,
  );
}

@immutable
class _widget__basic__building /*
inspired by "Builder" of "flutter/widgets/basic.dart" */ //
    extends StatelessWidget {
  const _widget__basic__building({
    required this.child__build /*
