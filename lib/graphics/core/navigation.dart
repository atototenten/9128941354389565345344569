...
const //
navigation__overlay__background__color = /*color__transparent__dark*/ Color.from(alpha: .5, red: 0, green: 0, blue: 0),
    navigation__animation__duration__default = Duration(
      milliseconds: (date_time.duration__second__seconds__milli ~/ (3 * 2)),
    );

typedef navigation___compo = NavigatorState;

extension widget__building__context__navigation___extension
    on //
        widget__building__context___compo {
  navigation___compo navigation({
...
extension navigation___extension
    on //
        navigation___compo /*
  ...
  <entity__type extends entity__overlay___compo>(
    ...
    return ModalBottomSheetRoute<void>(
      ...
      backgroundColor:
          ...
          : color__transparent__light),
      elevation: 0,
      clipBehavior: Clip.none,
      constraints: () {
        final wall__size = wall__size__default();
