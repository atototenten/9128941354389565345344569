...
/*const //
    ...
    rich_text__link___protocol__list = <string>[
      net__web__scheme__fix__pre,
      net__web__scheme__secure__fix__pre,
    ];
...
widget___protocol rich_text__image({
  ...
  void___procedure__format? re_build;

  BS1__array? image;

  final //
      image__widget = value__asyn__handling__widget(
...
TextStyle text__rich__style__not() => //
    text__style(
...
TextStyle text__rich__style__bold() => //
    text__style(
      font__color: color__foreground__default,
      font__size: 18.px(),
...
TextStyle text__rich__style__title() => //
    text__style(
...
TextStyle text__rich__style__heading() => //
    text__style(
      font__color: color__foreground__default,
      font__size: 24.px(),
      font__weight: FontWeight.bold,
...
TextStyle text__rich__style__sub_title() => //
    text__style(
      font__color: color__foreground__default,
      font__size: 24.px(),
      font__weight: FontWeight.w600,
...
TextStyle text__rich__style__sub_heading() => //
    text__style(
...
TextStyle text__rich__style__fade() => //
    text__style(
      font__color: color__foreground__dim,
      font__size: 16.px(),
      font__weight: FontWeight.normal,
...
TextStyle text__rich__style__code() => //
    text__style(
      font__color: color__foreground__default,
      font__size: 16.px(),
      font__weight: FontWeight.normal,
...
ARRAY<widget___protocol> str__wide__rich__bytes__convert({
  ...
  final //
      ...
      widget__list /* lines, in-case of text */ = list<widget___protocol>();
      ...
      case str__wide__rich__type__text:
        {
          ...
          switch (section__control__bytes.read__byte()) {
            ...
            case str__wide__rich__text__style__fade:
              style = text__rich__style__fade();
              break;
            case str__wide__rich__text__style__code:
              style = text__rich__style__code();
              break;
