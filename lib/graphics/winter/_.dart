...
import "package:foundation/graphics/core/_.dart";
...
void app__page__background__change() {
  ...
  if (app__theme__colors__ground__back__contrast__dark___ok) {
    preference__page__background__dark = //
...
const theme__winter = (
  ...
  box__collection: (
    base: box__winter__base,
    simple: box__winter__base__simple,
    non_button: box__winter__non_button,
    button: box__winter__button,
    floating: box__winter__floating,
    button__floating: box__winter__button__floating,
  ),
);
...
void box__winter__page__background__set() {
  page__background__decoration = (app__theme__colors__ground__back__contrast__dark__ok
      ? BoxDecoration(
...
void box__winter__color__set() {
  ...
  /*SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
    statusBarColor: color__transparent__dark,
    statusBarIconBrightness: (interface__bDark //
        ? Brightness.light
        : Brightness.dark),
    systemNavigationBarColor: color__transparent__dark,
  ));*/

  SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
    systemNavigationBarColor: color__transparent__dark,
    systemNavigationBarDividerColor: color__transparent__dark,
    systemNavigationBarIconBrightness: (app__theme__colors__ground__back__contrast__dark___ok //
        ? Brightness.light
        : Brightness.dark),
    systemNavigationBarContrastEnforced: FALSE,
    statusBarColor: color__transparent__dark,
    statusBarIconBrightness: (app__theme__colors__ground__back__contrast__dark___ok //
        ? Brightness.light
        : Brightness.dark),
...
widget___protocol winter__box__base({
...
widget___protocol winter__box__base__simple({
  final BorderRadius? border__radius,
  final BOOL b__highlight = FALSE,
  required final widget___protocol child,
}) =>
...
widget___protocol _box__shadowed({
  final BorderRadius? border__radius,
  final BOOL b__highlight = FALSE,
  required final widget___protocol child,
}) =>
...
widget___protocol winter__box__non_button({
  final BOOL b__highlight = FALSE,
  final BorderRadius? border__radius,
  required final widget___protocol child,
}) /* colored */ =>
...
widget___protocol winter__box__button({
  final BOOL b__highlight = FALSE,
...
widget___protocol winter__box__floating({
  BorderRadius? border__radius,
...
widget___protocol winter__box__button__floating({
  BorderRadius? border__radius,
  final BOOL b__highlight = FALSE,
  final ui.ImageFilter? blur,
  required final widget___protocol child,
...
/*typedef _function__box__base = widget___protocol Function({
  BorderRadius? border__radius,
  BOOL b__highlight,
  required widget___protocol child,
});

typedef _function__box__base__simple = _function__box__base;

typedef _function__box__non_button = widget___protocol Function({
  BOOL b__highlight,
  BorderRadius? border__radius,
  required widget___protocol child,
});

typedef _function__box__button = widget___protocol Function({
  BOOL b__highlight,
  BorderRadius? border__radius,
  required widget___protocol child,
...
typedef _function__box__floating = widget___protocol Function({
  BorderRadius? border__radius,
  ui.ImageFilter? blur,
  required widget___protocol child,
});

typedef _function__box__button__floating = widget___protocol Function({
  BorderRadius? border__radius,
  BOOL b__highlight,
  ui.ImageFilter? blur,
  required widget___protocol child,
...
/* late _function__box__base box__base;
late _function__box__base__simple box__base__simple;
late _function__box__non_button box__non_button;
late _function__box__button winter__box__button;
late _function__box__floating box__floating;
late _function__box__button__floating winter__box__button__floating; */

/* typedef box___compo = ({
  _function__box__base base,
  _function__box__base__simple simple,
