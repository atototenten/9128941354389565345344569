                    ...
                    build: (final state) => //
                        (input__b__simple //
                            ...
                            : scrollable(
                                ...
                                extent__cache: listing__vertical__caching__extent__default,
                                slivers: [
                                  SliverToBoxAdapter(
                                    child: $text(
                                      input__read(),
...
widget___protocol listing__item__input__text__stored({
  ...
  final result = widget__definitive__build(
    (final context) => //
        GestureDetector(
      child: listing__item(
        body: (((input != null) && (input != input__initial)) //
            ? box__text__secondary__primary(
                secondary__text: title,
                primary__text: input!,
              )
            : (input__b__required
                ? box__text__primary__secondary__auto(
                    primary__text: title,
                ...
                : ((sub_title != null)
                    ? box__text__multi(
                        ...
                        bottom: box__text__secondary(sub_title),
                      )
                    : _title__optional(title)))),
        trailing: (indicator__edit_able__b__show //
            ? icon(icon__edit__outline)
            : NIL),
...
widget___protocol _title__optional(
  final string title,
) =>
    Row(
        ...
        hence `auto_focus` should be not-working correctly */
{
  ...
  FIX.long
    `overlay__bottom__menu`'s `screen__padding.bottom` as bottom padding, respecting virtual/soft keyboard, is NOT visible in GUI
      ...
      tried
        `widget__build__definitive` with `app__size__broadcast` listening and re-build-ing
