...
widget___protocol input__text__overlay__bottom__keyboard({
/*
`if(listing.size.height < (view.size.height + keyboard.size.height/*(view.size.height /2)*/))`
  ...
  required final widget___protocol page__widget,
}) /*
...
//
      icon__key__backspace = flutter__material__icons.backspace_sharp,
      icon__key__capslock = flutter__material__icons.keyboard_capslock_sharp,
      icon__key__shift = flutter__material__icons.keyboard_arrow_up,
      icon__key__enter = flutter__material__icons.keyboard_return_sharp,
      icon__key__spacebar = flutter__material__icons.space_bar_sharp;

  widget___protocol _button({
