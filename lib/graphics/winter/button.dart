...
widget___protocol winter__button__structure({
...
typedef button___compo = widget___protocol Function({
  APPROX scale,
...
widget___protocol winter__button({
  final APPROX scale = 1,
...
widget___protocol winter__button__floating({
  final APPROX scale = 1,
  final BorderRadius? border__radius,
  final BOOL selected___ok = FALSE,
  final IconData? icon,
...
widget___protocol winter__button__floating__basic({
