...
widget___protocol pages__file__page(
  ...
  return page__foundation(
    list_ing__generat_ed(
      ...
      page__briefing: Padding(
        ...
        child: listing__item__info(
          body: box__text__primary("Press to switch, between, raw, and ASCII encoding"),
        ),
      ),
          ...
          children: <widget___protocol>[
            ...
            Expanded(
              ...
              child: widget__build__definitive(
                build: (final state) {
                  final ARRAY<widget___protocol> row__children;

                  if (b__aligned_) //
                    row__children = ARRAY<widget___protocol>.generate(
                      file__segment__size,
                      (final i) => //
                          Expanded(
                        child: box__text__widget(
                    ...
                    row__children = ARRAY<widget___protocol>.filled(
                      file__segment__size,
                      const Expanded(
                        child: empty__widget,
                      ),
