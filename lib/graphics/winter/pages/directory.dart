...
string file__path__convert__name(final string file_path) => //
    file_path.substring(file_path.lastIndexOf(storage__file__path__separation__char) + 1);
...
widget___protocol overylays__file_system__in_existence__alert(
...
widget___protocol pages__directory__page(
  final widget__building__context___compo context,
                  ...
                  (b__type__file //
                      ? _button(icon__file__open, () {
                          final //
                              ...
                              $$scroll__manager = scrolling.create();
