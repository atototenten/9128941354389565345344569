...
class program__info__page__entity //
    implements entity__component___protocol {
  program__info__page__entity() //
      : scroll__manager = scrolling();

  final scrolling scroll__manager;

  @override
  widget___protocol widget(final widget__building__context___compo context) {
    final //
        ...
        items = <widget___protocol>[
          list_ing__shell(
            items: <widget___protocol>[
              list_ing__shell__title(
          ...
          listing__item(
            body: box__text__primary__secondary(
              app__theme__colors__ground__back__contrast__dark__ok.toString(),
    ...
    return page__foundation(
      list_ing__generat_ed(
        ...
        page__title: page__title__aligned__center(
