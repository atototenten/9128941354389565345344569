...
typedef storage__data__table__main__array___compo = //
    ARRAY<storage__data__table__column__compo>;

void storage__data__table__main__array__write(
  final storage__data__meta___compo ds__meta, {
  required final storage__data__table__main__array___compo table__main__array,
}) {
  if (printing___ok) {
  ...
  final //
      ...
      tbl__size = storage__data__main__tbl__size(
        table__array__count,
      ),
    ...
    (final table__id) {
      final //
          ...
          bytes /* macro */ = tbl__bytes.view(
            storage__data__main__tbl__size(
              table__id,
            ),
          );
      ...
      switch (table__column.type) {
        case storage__data__table__column__type___enum.tar:
          storage__data__tar__create(
            ds__meta,
            column__bytes: bytes,
            rows__count__size__id: (table__column.meta as storage__data__table__column__type__tar__meta__compo).rows__count__size__id,
          );
  ...
  storage__data__write(
    ...
    storage__data__offset: storage__data__main__tbl__offset,
  );

  printing__indentation__decrease();
}

storage__data__table__meta___protocol storage__data__table__main__open(
  final storage__data__meta___compo ds__meta, {
  required final storage__data__table__main__array___compo table__main__array,
  ...
  final //
      ...
      column__bytes = storage__data__read(
        ds__meta,
        count: (storage__data__table__main__rows__count__size + storage__data__position__size__id.size),
        storage__data__offset: column__bytes__base__storage__data__offset,
      ),
      table__column = table__main__array[table__main__id];

  final storage__data__table__meta___protocol result;

  switch (table__column.type) {
    case storage__data__table__column__type___enum.tar:
      final //
          column__meta = (table__column.meta as storage__data__table__column__type__tar__meta__compo),
          details /* ignored, if `(rows__count == 0)` */ = storage__data__table__row__column__type__in_direct__bytes__read(
            column__meta: column__meta,
            column__bytes: column__bytes,
          );

      result = storage__data__tar__meta___compo(
    ...
    case storage__data__table__column__type___enum.tbl:
      ...
      result = storage__data__tbl__meta___compo(
        rows__count: details.count,
        rows__count__size__id: column__meta.rows__count__size__id,
        rows__count__max: column__meta.rows__count__max,
        row__size: column__meta.row__size,
