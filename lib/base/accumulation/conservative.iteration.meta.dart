  ...
  element-position calc.ion is partially(just the accum. ,not the arrays) iterative(with a single branch) */
{
  ...
  static NIMR //
      array__elements__count__ideal__raw({
    required final NIMR array__id,
    required final NIMR array__first__elements__count__doubling__initial,
  }) {
  ...
  static NIMR //
    ...
    return array__elements__count__ideal__raw(
      array__id: 0,
...
can be zero */
  ...
  })  : array__current__id__raw = 0,
        elements__offset__raw = 0,
        elements__count__remaining__raw = elements__count;

  final NIMR //
      array__first__elements__count__doubling__initial;

  NIMR //
      elements__count__remaining__raw /*
from `.elements__offset`
  hence including the current array's elements */
      ,
      elements__offset__raw,
      array__current__id__raw;

  BOOL //
      elements__remaining__ok__raw({
    required final NIMR array__current__elements__count__ideal,
  }) {
    return (elements__count__remaining__raw >= array__current__elements__count__ideal);
  }

  BOOL //
      elements__remaining__ok() {
    return elements__remaining__ok__raw(
      array__current__elements__count__ideal: array__current__elements__count__ideal__raw(),
    );
  }
...
excluding the current-array's elements */
    ...
    final //
        array__current__elements__count__ideal = array__current__elements__count__ideal__raw(),
        iteration__current__last__ok = iteration__current__last__ok__raw(
          array__current__elements__count__ideal: array__current__elements__count__ideal,
        );

    if /*F*/ (iteration__current__last__ok) {
      return 0;
    }
  ...
  NIMR //
      array__current__elements__count__raw /*
needed only for the last iteration
  other(non-last) iterations {can and should} use {ideal elements-count}
    ...
    if /*F*/ (iteration__current__last__ok) {
      return elements__count__remaining__raw;
    }
  ...
  NIMR //
      array__current__elements__count__ideal__raw() {
    return array__elements__count__ideal__raw(
      array__id: array__current__id__raw,
      array__first__elements__count__doubling__initial: array__first__elements__count__doubling__initial,
    );
  }

  NIMR //
      array__previous__elements__count__ideal__raw() {
    if (iteration__current__first__ok()) {
      throw "in-valid call : `iteration__current__first__ok`";
    }

    final array__previous__id = (array__current__id__raw - 1);
  ...
  BOOL //
      iteration__current__last__ok__raw({
    required final NIMR array__current__elements__count__ideal,
  }) {
    return (elements__count__remaining__raw < array__current__elements__count__ideal);
  }
  ...
  BOOL //
      iteration__current__first__ok() {
    if (elements__offset__raw == 0) {
      if (array__current__id__raw != 0) {
        throw "exception : `(array__current__id__raw != 0)`($array__current__id__raw != 0)";
      }
  ...
  ({
    ...
    return (
      elements__offset: elements__offset__raw,
      array: (
        id: array__current__id__raw,
        elements__count: array__current__elements__count__raw(),
      ),
    );
  }

  void iterate__forward__raw({
    required final NIMR array__current__elements__count__ideal,
  }) {
    {
      final iteration__current__last__ok_1 = iteration__current__last__ok__raw(
        array__current__elements__count__ideal: array__current__elements__count__ideal,
      );

      if (iteration__current__last__ok_1) {
        throw "in-valid call : `(iteration__current__last__ok & elements__remaining__not)`";
      }
    }

    elements__offset__raw += array__current__elements__count__ideal;
    elements__count__remaining__raw -= array__current__elements__count__ideal;

    array__current__id__raw += 1;
  }

  void iterate__forward /*
to next-array in the accum. */
      () {
    iterate__forward__raw(
      array__current__elements__count__ideal: array__current__elements__count__ideal__raw(),
    );
  }

  NIMR /*array__current__elements__count__ideal*/ iterate__backward__raw() {
    {
      final iteration__current__first__ok_1 = iteration__current__first__ok();
    ...
    final array__current__elements__count__ideal = array__current__elements__count__ideal__raw() /*
...
re-set */
    ...
    elements__count__remaining__raw += elements__offset__raw;
  ...
  void elements__remaining__ensure__raw() {
    final elements__remaining__ok_1 = elements__remaining__ok();
  ...
  NIMR /*array__elements__offset*/ //
      iterate__forward__until /*
forward-iterate until the element is present in the current-array */
      (
    NIMR element__id,
  ) {
    element__id -= elements__offset__raw;

    if (element__id >= elements__count__remaining__raw) {
      throw "in-valid call : `(element__id >= (elements__count__remaining__raw + elements__offset__raw))`(${element__id + elements__offset__raw} >= ($elements__count__remaining__raw + $elements__offset__raw))";
    }

    {
      final array__current__elements__count = array__current__elements__count__raw();

      if (element__id < array__current__elements__count) /*
last-array ,hence no-where to forward */
      {
        throw "in-valid call : `(element__id < array__current__elements__count)`(${element__id + elements__offset__raw} < $array__current__elements__count)";
      }
    }
...
current array is either last ,or the needed one */
      ...
      elements__remaining__ensure__raw();
...
backward-iterating equivalent of `.iterate__forward__until`
  although control-flow is asymmetric ,due to being based on beginning/offset */
    ...
    if (element__id >= elements__offset__raw) {
      throw "in-valid call : `(element__id >= .elements__offset)`($element__id >= $elements__offset__raw)";
    }

    while (OK) {
      final array__current__elements__count__ideal = iterate__backward__raw();
...
declarative approach */
    ...
    final NIMR offset = 0,
    required final BOOL /*iterate__ok*/ Function(
      NIMR elements__offset,
      NIMR array__id,
      NIMR array__elements__count,
      NIMR array__elements__offset,
    ) array__handle,
  }) {
    if (((count != null) //
            ...
            : offset) /*end*/ >
        (elements__count__remaining__raw + elements__offset__raw)) {
      throw "in-valid call : `((count + offset) > (.elements__count__remaining + .elements__offset))`((${count ?? Null__value__text} + $offset) >= ($elements__count__remaining__raw + $elements__offset__raw))";
    }
    ...
    if /*F*/ (offset == 0) {
      if /*F*/ (elements__offset__raw != 0) {
        iteration__set__initial();
      }

      iteration__count = (count ?? elements__count__remaining__raw);

      array__elements__offset = 0;
    } else if /*F*/ (offset < elements__offset__raw) {
      iteration__count = (count ?? (elements__count__remaining__raw + (elements__offset__raw - offset)));
      ...
      array__elements__offset = 0;
    } else /*if (offset > elements__offset__raw)*/ {
      iteration__count = (count ?? (elements__count__remaining__raw - (offset - elements__offset__raw)));

      final elements__count = ((iteration__count + offset) - elements__offset__raw);
      if (elements__count > elements__count__remaining__raw) {
        throw "in-valid call : `(elements__count\\$elements__count\\ > elements__count__remaining\\$elements__count__remaining__raw\\)`";
      }

      final array__current__elements__count = array__current__elements__count__raw();

      if (offset < array__current__elements__count) {
        array__elements__offset = (offset - elements__offset__raw);
      } else {
    ...
    if /*F*/ ((iteration__count == 0) || //
        (iteration__count == 1)) {
      final iterate__ok = array__handle(
        elements__offset__raw,
        array__current__id__raw,
        iteration__count,
        array__elements__offset,
    ...
    while (OK) {
      final //
          array__current__elements__count = array__current__elements__count__raw(),
          array__last__ok = (iteration__count <= array__current__elements__count),
          array__elements__count = (array__last__ok /*F*/ //
              ? iteration__count
  ...
  void iterate__auto__granular({
    ...
    final NIMR offset = 0,
    required final BOOL /*iterate__ok*/ Function(
      NIMR accumulation__element__id /* `(array__element__id + accumulation__elements__offset)` */,
      NIMR array__offset /*array__element__id*/,
    ) element__handle,
  }) {
    iterate__auto(
      count: count,
  ...
  base__text__representation //
    ...
    return base__compo__text__representation(
      ...
      members: {
        "elements__count__remaining": elements__count__remaining__raw.text__representation(),
        "elements__offset": elements__offset__raw.text__representation(),
        "array__current__id": array__current__id__raw.text__representation(),
      },
    );
  }
}
    ...
    () {
  {
    ...
    [
      ...
      (final i, final e) {
        ...
        if ((iteration__meta.elements__count__remaining__raw != e.result.elements__count__remaining) || //
            (iteration__meta.elements__offset__raw != e.result.elements__offset) || //
            (iteration__meta.array__current__id__raw != e.result.array__current__id)) {
...

  {
    ...
    [
      ...
      (final i, final e) {
        ...
        if (iteration__meta.array__current__elements__count__ideal__raw() != e.result.array__first__elements__count__ideal) {
          throw "tests__$name[$i] failed";
        }
      },
    );
...

  {
    ...
    [
      ...
      (final i, final e) {
        ...
        } else if ((iteration__meta.elements__count__remaining__raw != result.elements__count__remaining) || //
            (iteration__meta.elements__offset__raw != result.elements__offset) || //
            (iteration__meta.array__current__id__raw != result.array__current__id)) {
          throw "tests__$name[$i] failed";
        }
      },
    );
...

  {
    ...
    [
      ...
      (final i, final e) {
        ...
        if ((iteration__meta.elements__count__remaining__raw != result.elements__count__remaining) || //
            (iteration__meta.elements__offset__raw != result.elements__offset) || //
            (iteration__meta.array__current__id__raw != result.array__current__id)) {
          throw "tests__$name[$i] failed";
        }
