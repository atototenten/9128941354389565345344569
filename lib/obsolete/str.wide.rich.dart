...
//
    str__wide__rich__text__style__link___protocol__web /*__http*/ = 0,
    str__wide__rich__text__style__link___protocol__web__secure /*__https*/ = (1 + str__wide__rich__text__style__link___protocol__web),
//
...
string str__wide__rich__text__style__convert__string(
  ...
  if (text__style < style__array.elements__count) //
    return style__array[text__style];

  throw "un-known text.style, $text__style";
}

typedef str__wide__rich__text__segment__kampo = ({
  uu offset,
  uu count,
});

byte__array str__wide__rich__convert__bytes(
  final wstr
      str__wide__rich /*
  ...
  void text__add(
    ...
    uu count = 0;
    {
      ...
      list__add(
        text__segment__list__list,
        (text__segment__list = list<str__wide__rich__text__segment__kampo>()),
      );
    }
    report__uu(
      count,
...
/*
                      ...
                      text__segment__list__check__empty((str__iter - (3 + 2)));
                      {
                        ...
                        final u8 column__array__count;
                        {
                          final //
                              ...
                              column__b__number__array = str__wide__rich.view__partial(
                                str__iter,
                                (id - str__iter),
                              );

                          sink.add__uu(
                            (column__array__count = column__b__number__array.elements__count),
                          );

                          sink.add(byte__array__new__generated(
                              column__array__count,
                              (final column__iter) => //
                                  ((column__b__number__array[column__iter] != ch__number__one) /* b__not__number */
                                      ? 0
                                      : 1)));
  ...
  final result = byte__array__array__catinate([
    uu__convert__bytes(
      sink__size,
    ),
      ...
      case str__wide__rich__type__table:
        ...
        report__array(
          array__new__generated(
              column__array__count,
              (final column__id) => //
                  (column__b__number__array[column__id] != 0)),
