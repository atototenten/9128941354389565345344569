...
must be `>= data:group:level:3:element:arr:count` 
    ...
    if (data__element__array__init_ial == null) {
      ...
      await base__iterate__basic__asyn(
        ...
        (final data__group__level__1__element__id) async {
          $accumulation.add(
            data__fetch_ing__data__group__level__1__kampo(
              data__group__level__3__id: data__group__level__3__id,
              data__group__level__2__element__array: await data__element__array__fetch(
      ...
      result = array__new__generated(
        ...
        (final data__group__level__1__element__id) {
          final //
              ...
              data__group__level__2__element__array = array__new__copy(
                data__element__array__init_ial,
          ...
          return data__fetch_ing__data__group__level__1__kampo(
            data__group__level__3__id: data__group__level__3__id,
            data__group__level__2__element__array: data__group__level__2__element__array,
          );
        },
      );
    }
  ...
  data__fetch_ing(
    this.$_data__group__level__2__element__array,
...
`data__group__level__3__id`, instead of `data__group__level__1__element__id`, because
  ...
  and, the former, requires, less-er memory-space */
    ...
    return ($_data__group__level__2__element__array[data__group__level__2__element__id] = data__fetch_ing__data__group__level__1__kampo(
      data__group__level__3__id: data__group__level__3__id,
...
class data__fetch_ing__data__group__level__1__kampo<data__type> {
  data__fetch_ing__data__group__level__1__kampo({
    required this.data__group__level__3__id,
    required this.data__group__level__2__element__array,
...
({
  ...
  final data__element__id__offset = (data__group__level__1__element__id /* `*data__group__level__1__element__array__count` */ << data__fetch_ing__data__group__level__1__element__array__count__width);
...
value__asyn<void> main() async {
  ...
  final fetch_ing = await data__fetch_ing.init_(
    ...
    data__element__array__fetch: (final data__group__level__1__element__id) {
