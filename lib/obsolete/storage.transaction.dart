...
abstract class Transaction {
  ...
  static void _registerFileOperation(
    ...
    final bytes = byte__array__array__catinate(<byte__array>[
      str__ascii__convert__ascii(absoluteFilePath),
      (u8__array(2) /* `..[0] = 0` which is default hence omitted */ ..[1] = type) /** this value could be cached in a static,  nullable variable, but c would anyways solve this */,
  ...
  static void registerAppendFileOperation(
    ...
    _registerFileOperation(
      ...
      uu__convert__byte__array__little_endian(fileSize, u64__size),
    );
  ...
  static void registerModifyFileOperation(
    ...
    _registerFileOperation(
      ...
      byte__array__array__catinate(<byte__array>[
        (u64__array(2)
              ..[0] = position
