...
\
	ls__by__array__list__ADD.bytes___count += bys__count__by__array__list__ADD;\
}
/*
...
{\
	/*printf("%ju(ls.elements__count)"\
		...
		ls__by__array__list__CONVERT__by__arr.bytes___count,\
		ls__by__array__list__CONVERT__by__arr.first,\
		ls__by__array__list__CONVERT__by__arr.last);*/\
\
	bys__count__by__array__list__CONVERT__by__arr = ls__by__array__list__CONVERT__by__arr.bytes___count;\
...
\
	do {\
		/*printf("%p(iter)"\
			", %ju(iter.bytes___count)"\
			", %p(iter.bys)"\
			", %p(iter.next)"\
			"\n",\
			iter__by__array__list__CONVERT__by__arr,\
			(*iter__by__array__list__CONVERT__by__arr).bytes___count,\
			(*iter__by__array__list__CONVERT__by__arr).bys,\
			(*iter__by__array__list__CONVERT__by__arr).next);*/\
\
		bys__count___by__array__list__CONVERT__by__arr = \
			(bys__count__by__array__list__CONVERT__by__arr = (*iter__by__array__list__CONVERT__by__arr).bytes___count);\
